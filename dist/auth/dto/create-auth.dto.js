...
class AuthResponse {
    static _OPENAPI_METADATA_FACTORY() {
        return { token: { required: true, type: () => String }, permissions: { required: true, type: () => [String] }, name: { required: false, type: () => String }, email: { required: false, type: () => String }, id: { required: false, type: () => Number } };
    }
}
